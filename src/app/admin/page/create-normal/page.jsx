    ...
    const createPage = async (e) => {
        ...
        if (flag) {
            ...
            const data = {
                ...
                url,metaTitle, metaKeywords, metaDescriptions, sections,shortContent,mainTitle,pageType
            }
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Create Normal Page</h4>

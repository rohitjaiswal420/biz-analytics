...
export default function Page() {
    ...
    const addSection = () => {
        ...
        setSections((prev) => [...prev, { sectionImage: null, content: null, label: null, id: null }])
    }
    ...
    const createPage = async (e) => {
        ...
        if (flag) {
            ...
            if (res.status) {
                ...
                sessionStorage.setItem('successMsg', 'Page Created Successfully');
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Create Service Page</h4>
                                ...
                                <div className="card-body">
                                    <form onSubmit={createPage}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="url-input" placeholder="Enter url name" name='url' style={{ border: formValidation.url === 0 && '1px solid red' }} />
                                        </div>
                                        ...
                                        {/* <div className="mb-3">
                                            ...
                                            <select name="page" id="select-input" className="form-control" style={{ border: formValidation.page === 0 && '1px solid red' }} >
                                                ...
                                                <option value="Normal Page" >Normal Page</option>
                                                <option value="Service Page" >Service Page</option>
                                                <option value="Product Page" >Product Page</option>
                                                <option value="Industry Page" >Industry Page</option>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="text" className="form-control" id="title-input" placeholder="Enter title" name='title' style={{ border: formValidation.title === 0 && '1px solid red' }} />
                                        </div>

                                        {/* <div className="mb-3">
                                            <label className="form-label" htmlFor="Description">Short Description</label>
                                            <textarea className="form-control" rows={3} placeholder='type...' name='description' id='Description' style={{ border: formValidation.description === 0 && '1px solid red' }} />
                                        ...
                                        <div className="mb-3" >
                                            {sections.length > 0 && sections.map((section, i) => <div key={i} className="content-section">
                                                ...
                                                <h3>Tab {i + 1}</h3>
                                                <label className="form-label" htmlFor={`project-section-img${i}`}>Tab Image</label>
                                                <input className="form-control" id={`project-section-img${i}`} type="file" name='sectionImage' accept="image/*" onChange={(e) => handleSection(e, i)} required />
                                                <div style={{ marginTop: '10px' }}>Choose 1520 x 451 Dimension</div>
                                                ...
                                                />
                                                <br />
                                                <label className="form-label" htmlFor="section-label">Tab Label</label>
                                                <input type='text' name="label" id="section-label" className="form-control" required onChange={(e) => handleSection(e, i)} placeholder='Enter tab label' />
                                                <br />
                                                <label className="form-label" htmlFor="section-id">Tab Id</label>
                                                <input type='text' name="id" id="section-id" className="form-control" required onChange={(e) => handleSection(e, i)} placeholder='Enter tab id' />

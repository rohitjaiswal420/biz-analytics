          ...
          <ul className="navbar-nav" id="navbar-nav">
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards" >
                <i className="ri-database-line" /> <span data-key="t-Manage Blogs">Manage Blogs</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards">
                <ul className="nav nav-sm flex-column">

                  <li className="nav-item">
                    <Link href="/admin/blog/create" className="nav-link" data-key="t-create"> create </Link>
                  </li>
                  <li className="nav-item">
                    <Link href="/admin/blog" className="nav-link" data-key="t-list"> list </Link>
                  </li>
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards1" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                <i className="ri-file-image-line" /> <span data-key="t-Manage Slider">Manage Slider</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards1">
                <ul className="nav nav-sm flex-column">

                  <li className="nav-item">
                    <Link href="/admin/slider/create" className="nav-link" data-key="t-create"> create </Link>
                  </li>
                  <li className="nav-item">
                    <Link href="/admin/slider/list" className="nav-link" data-key="t-list"> list </Link>
                  </li>
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards3" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                <i className="ri-file-image-line" /> <span data-key="t-Manage Offers">Manage Gallery</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards3">
                <ul className="nav nav-sm flex-column">

                  <li className="nav-item">
                    <a href="/admin/gallery/create" className="nav-link" data-key="t-create"> create </a>
                  </li>
                  <li className="nav-item">
                    <a href="/admin/gallery/list" className="nav-link" data-key="t-list"> list </a>
                  </li>
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards4" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                <i className="ri-info-i" /> <span data-key="t-Manage Inquiry">Manage Inquiry</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards4">
                <ul className="nav nav-sm flex-column">
                  ...
                  <li className="nav-item">
                    <a href="/admin/inquiry" className="nav-link" data-key="t-list"> list </a>
                  </li>
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards5" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                <i className="ri-user-forbid-line" /> <span data-key="t-Manage Inquiry">Manage Testimonial</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards5">
                <ul className="nav nav-sm flex-column">
                  ...
                  <li className="nav-item">
                    <a href="/admin/testimonial/create" className="nav-link" data-key="t-create"> create </a>
                  </li>

                  <li className="nav-item">
                    <a href="/admin/testimonial/list" className="nav-link" data-key="t-list"> list </a>
                  </li>
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards6" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                <i className="ri-infinity-line" /> <span data-key="t-Manage Inquiry">Manage Pages</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards6">
                <ul className="nav nav-sm flex-column">
                  ...
                  <li className="nav-item">
                    <a href="/admin/page/create" className="nav-link" data-key="t-create"> create </a>
                  </li>

                  <li className="nav-item">
                    <a href="/admin/page/list" className="nav-link" data-key="t-list"> list
                    </a>
                  </li>
            ...
            <li className="nav-item">
              <a className="nav-link menu-link" href="#sidebarDashboards7" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards">
                <i className="ri-user-follow-line" /> <span data-key="t-Manage Inquiry">Manage Subscription</span>
              </a>
              <div className="collapse menu-dropdown" id="sidebarDashboards7">
                <ul className="nav nav-sm flex-column">
                  ...
                  <li className="nav-item">
                    <a href="/admin/subscription" className="nav-link" data-key="t-list"> list </a>
                  </li>

...
export default function ServicePageUpdate({ pageDetail, Blogstatus, Blogstatus1 }) {
    ...
    const [status1, setStatus1] = useState(Blogstatus1);
    ...
    const createPage = async (e) => {
        ...
        if (flag) {
            ...
            const data = {
                ...
                url, metaTitle, metaKeywords, metaDescriptions, sections, mainTitle,
                pageId: pageDetail.pageId, status
            }
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                                <h4 className="mb-sm-0">Update Service Page</h4>
                                    ...
                                    <form onSubmit={createPage}>
                                        ...
                                        <div className="mb-3" >
                                            {sections.length > 0 && sections.map((section, i) => <div key={i} className="content-section">
                                                ...
                                                <input className="form-control" id={`project-section-img${i}`} type="file" name='sectionImage' accept="image/*" onChange={(e) => handleSection(e, i)} />
                                                <div style={{ marginTop: '10px' }}>Choose 1520 x 451 Dimension</div>
                                                ...
                                                <input type='text' name="label" id="section-label" className="form-control" required onChange={(e) => handleSection(e, i)} placeholder='Enter tab label' value={section.label} />
                                                <br />
                                                <label className="form-label" htmlFor="section-id">Tab Id</label>
                                                <input type='text' name="id" id="section-id" className="form-control" required onChange={(e) => handleSection(e, i)} placeholder='Enter tab id' value={section.id} />
